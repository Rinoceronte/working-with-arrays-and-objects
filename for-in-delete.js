...
for(let n in deleteTheBigNumbers) {
  if(deleteTheBigNumbers[n] > 100) {delete deleteTheBigNumbers[n];}
}
...
function startsWithK(obj) {
  for(let o in obj)
  {
    if(o.startsWith('k')) { delete obj[o]; }
  }
  return obj;
}
